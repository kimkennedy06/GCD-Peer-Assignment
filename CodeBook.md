...
1. **Time_Domain_Body_Accelerometer_Mean_Y** renamed from 'tBodyAcc-m'test'ean()-Y' in feat'features.txt'ures.txt this variable’s data is collection of 'train' and 'test' data.             
